<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    $query = "SELECT * FROM `admin credentnials` WHERE name='$name' and password='$password'; ";
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            <button type="submit" class="btn btn-primary btn-style mt-4" name="submit">Login</button>
                        </div>
                    </form>
                    <!-- //form -->
                </div>
